...
public class gamectrl : MonoBehaviour
{
    ...
    void wrtieBook(int hanghao, int liehao)
    {
        ...
        if (temp.GetComponent<Text>().preferredHeight > jichu)
        {
            ...
            tempzb = new Vector3(0, -(Ynum - (temp.GetComponent<Text>().preferredHeight / jichu - 1) * jichu / 2), 0);
    ...
    void buttonWriteText(string temp)
    {
       ...
       //print("高度"+writeimage.GetComponent<Text>().preferredHeight);
        ...
        Vector2 tempzb = new Vector3(0, -Ynum - writeimage.GetComponent<RectTransform>().sizeDelta.y);
        ...
        if (writetext.GetComponent<Text>().preferredHeight > jichu)
        {
            ...
            tempzb = new Vector3(0, -(Ynum - (writetext.GetComponent<Text>().preferredHeight / jichu - 1) * jichu / 2), 0);
        ...
        tempzb = new Vector3(0, -Ynum - writeimage.GetComponent<RectTransform>().sizeDelta.y);
